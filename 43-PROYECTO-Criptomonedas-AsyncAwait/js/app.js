// Proyecto cotizador de Cryptomonedas usando Async Await
...
async function consultarCriptomonedas () {
    ...
    try {
        ...
        const resultado = await respuesta.json(); // Obtenemos la respuesta de la peticion
        const criptomonedas = await obtenerCriptomonedas( resultado.Data ); // Espera la terminacion de la promesa
        selectCriptomonedas( criptomonedas ); // Llena los select con los resultados
...
async function consultarAPI () {
    ...
    try {
        const respuesta = await fetch( url ); // Peticion HTTP
        const cotizacion = await respuesta.json(); // // Obtenemos la respuesta de la peticion
        mostrarCotizacionHTML( cotizacion.DISPLAY[criptomoneda][moneda] ); // Con la respuesta muestra la cotizacion
